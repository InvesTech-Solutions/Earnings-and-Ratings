...
class Tag extends Component {
  ...
  render () {
    return (
      <div id="tagContainer">
        <div id="tagCircle" className="circleBase">
          <h2 className="tagContentHead">
            <svg width="20" height="20" viewBox="0 0 20 20" id="tagSvg">
              <g fill="#2BD89E" fill-rule="evenodd" transform="translate(-4 -4)">
